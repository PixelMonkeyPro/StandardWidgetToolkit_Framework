...
namespace EmbeddedApp
{
    ...
    public partial class AppContainer : Panel
    {
        ...
        protected override void OnResize(EventArgs eventargs)
        {
            if (AppProcess != null)
            {
                Win32API.MoveWindow(AppProcess.MainWindowHandle, 0, 0, Width, Height, true);
            }
        ...
        public string AppFilename
        {
            ...
            set
            {
                if (value == null || value == m_AppFilename)
                {
                    return;
                }
        ...
        /// 标识内嵌程序是否已经启动
        /// </summary>
        public bool IsStarted { get { return (AppProcess != null); } }
